...
class IndexController extends Controller {
    async Like() {
	  ...
	  let sql = 'update tbl_forum set like_count = like_count + 1 where content_id = $1'
	  console.log('like')
  ...
  async AddComment() {
	  ...
	  await this.app.postgres.query('update tbl_forum set comment_count = comment_count + 1 where content_id = $1', [data.content_id])
